...
let AppModule = class AppModule {
    ...
    async onModuleInit() {
        await this.addFauxPlayer();
    }
    async addFauxPlayer() {
        if (await this.playerRepository.count() === 0) {
            const fakeRanking = player_data_1.PLAYER_INVENTER.map((player, index) => ({
                id: player,
                rank: 1000 + index * 10,
...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [app_service_1.AppService, player_service_1.PlayerService, ranking_cache_service_1.CacheRankingService, match_service_1.MatchService],
    }),
